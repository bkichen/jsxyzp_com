/*******************************************************************************
截图的JS部分的核心流程封装在此文件中，绝大部分情况下，您不需要修改此文件中的JS内容，它已经包含了在所有浏览器上应用
截图所需要的所有代码，您只需要去修改capturewrapper.js，将相应的函数修改成与您的UI匹配的即可 
*******************************************************************************/
...
var	emSetMagnifierLogoText = 10; //设置放大镜上的LOGO字符，可提示快捷键，如： 截图(CTRL + SHIFT + A)     免费版本无效
...
function NiuniuCaptureObject() 
{
    ...
    this.LoadPlugin = function()
    {
        ...
        obj.html('');
        obj.html('<object id="niuniuCapture" type="application/x-niuniucaptureJXY" width="0" height="0"><param name="onload" value="onpluginLoaded" /></object>');
